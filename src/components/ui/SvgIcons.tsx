...
// Official Playwright Logo (Dual Mask Green & Teal)
...
// Official Apache JMeter Logo (Red Feather Gauge)
export function JMeterIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 128 128" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M64 36H64.01" stroke="#D22128" strokeWidth="10" strokeLinecap="round" />
    </svg>
  );
}
...
// Official Postman Logo (Orange Astronaut Rocket)
...
// Official GitHub Actions Logo (Blue Workflow Grid)
...
// Official GitLab Logo (Orange Multi-Faceted Fox)
